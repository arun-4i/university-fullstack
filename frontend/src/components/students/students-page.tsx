...
import { getStudentColumns } from "@/app/(protected)/students/columns";
// import { getData } from "@/services/actions";


export default function StudentsPage({ courseId }: { courseId?: string }) {
  ...
  return (
    <div>
      {!courseId && ( // Only show create button when not on course page
